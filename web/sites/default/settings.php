 ...
 * hostname from left to right and name from right to left. The first
 ...
 *   The default pattern provided below also excludes the ile system.
...
$conf['file_public_path'] = getenv('FILE_PUBLIC_PATH');
$conf['file_private_path'] = getenv('FILE_PRIVATE_PATH');
